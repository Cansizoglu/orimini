...
export function HeartIcon({ size = 28, className, filled = false }: IconProps & { filled?: boolean }) {
  return (
...
export function StarIcon({ size = 18, className, fill = 1 }: IconProps & { fill?: number }) {
  // fill: 0 boş, 1 dolu, arası yarım yıldız
